def calc_regret_global(distances, path1, path2, visited):
    ...
    for b in possibilities:
        ...
        if min_regret > max_regret:
            ...
            best_insert = (best_position1, b) if regret1 < regret2 else (best_position2, b)
            best_path = path1 if regret1 < regret2 else path2

    return best_insert, best_path


def two_regret_global(data, distances, starting_nodes):
    n = len(data)
