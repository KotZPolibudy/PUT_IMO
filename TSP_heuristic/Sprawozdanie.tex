...
Graficzną reprezentację wyników dla naszego algorytmu przestawiono na~\ref{fig:Our-kroA, fig:Our-kroB}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c||c|c|c||c|c|c|}
        ...
        \hline
        Split + Two regret & 30293.00 & 32952.21 & 37192.00 & 31341.00 & 33193.50 & 36531.00 \\
        \hline
    \end{tabular}
